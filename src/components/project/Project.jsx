      ...
      <div className="project">
        ...
        <div className="project-content-be">
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">Simon Says <a href="https://bhavikcodes.github.io/Simon-Says-/" target="_blank" rel="noopener noreferrer"><FaExternalLinkAlt className="linkIcon" /></a></h5>
              <p className="card-text">
                A fun interactive Simon Says game that tests user’s memory with color patterns. Built using <b>HTML</b>, <b>CSS</b>, and <b>JavaScript</b>.
              </p>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">Spotify Clone <a href="https://bhavikcodes.github.io/Spotify/" target="_blank" rel="noopener noreferrer"><FaExternalLinkAlt className="linkIcon" /></a></h5>
              <p className="card-text">
