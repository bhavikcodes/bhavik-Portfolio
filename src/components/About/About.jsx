...
import "./About.css";
import profile_img from "../../assets/face/c.jpg";
  ...
  return (
    <div id="about" className="about">
      <div className="about-title">
        <h1>
          About <span id="blue-text">Me</span>
        </h1>
      </div>
      <div className="about-section">
        ...
        <div className="about-para">
          <p>
            <b style={{ fontSize: "25px", fontWeight: "600" }}>Hello Recruiter!👋😃</b> I’m a 3<sup>rd</sup> year B.Tech student at UIT RGPV, Bhopal, specializing in Computer Science and Engineering. I have a strong foundation in C++ and Data Structures & Algorithms, and I enjoy solving real-world problems through efficient code.
            <br />
            ...
            My long-term goal is to become a skilled software engineer, contributing to impactful projects and innovations.
            I’m currently seeking internship opportunities to gain hands-on experience and grow as a developer.
          </p>
        </div>
      </div>
      <br />
