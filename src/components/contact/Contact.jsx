    ...
    <div id="contact" className='contact'>
      ...
      <div className="contact-section">
        ...
        <form className="contact-right" onSubmit={onSubmit} >
          ...
          <textarea name="message" rows="5" cols="30" placeholder='Enter your message' required/>
          <button className='btn-submit'>Send <i className="fa-solid fa-paper-plane"></i></button>
        </form>
      </div>
    </div>
  )
